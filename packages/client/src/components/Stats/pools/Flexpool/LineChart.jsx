...
export const LineChart = ({ dataChart }) => {
  ...
  const noData =
    ...
    dataChart[0].averageEffectiveHashrate === undefined ||
    dataChart[0].effectiveHashrate === undefined ||
  ...
  const effectiveHashrate = prepareDataset(
    { dataChart, key: "effectiveHashrate" },
    {
  ...
  const averageEffectiveHashrate = prepareDataset(
    { dataChart, key: "averageEffectiveHashrate" },
    {
  ...
  const labels = dataChart.map(({ timestamp }) => timestamp * 1000).reverse();
