    ...
    <div className={classes.root}>
      <TableContainer className={classes.table}>
        <Table aria-label="miner details">
          <TableHead>
            <TableRow>
              <TableCell className={classes.TableHead}>GPU Id</TableCell>
              ...
              <TableCell className={classes.TableHead}>Gpu Errors</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {gpus.map(
              ({
                ...
                return (
                  <TableRow key={idGpu}>
                    ...
                    <TableCell component="th">{restartCounter}</TableCell>
                  </TableRow>
                );
              }
            )}
